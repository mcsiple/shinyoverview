...
3. Output objects (`plotOutput()`, `textOutput()` etc.)

4. Input objects (`sliderInput()`,`fileInput()` etc.)

*Input objects are what link the user interface to the R code on the server.*
